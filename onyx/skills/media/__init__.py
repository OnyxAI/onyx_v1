...
class MediaSkill(OnyxSkill):
    ...
    def _register_event_handlers(self):
        """
           ...
           while onyx is speaking.
        """
        self.emitter.on('onyx.media.stop', self._media_stop)
    ...
    def before_play(self):
        ...
        self.emitter.emit(Message('onyx.media.stop', {'origin': self.name}))
    ...
    def stop(self):
        """
           ...
           function will be called by either the general onyx 'stop'
