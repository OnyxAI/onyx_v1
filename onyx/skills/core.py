...
from onyx.util.dialog import DialogLoader
    ...
    def register_intent(self, intent_parser, handler):
        ...
        def receive_handler(message):
            try:
                ...
                self.speak("An error occurred while processing a request in " + self.name, self.lang)
    ...
    def enable_intent(self, intent_name):
        ...
        for (name, intent) in self.registered_intents:
            if name == intent_name:
                ...
                logger.error('Could not enable ' + intent_name + ', it hasn\'t been registered.')
