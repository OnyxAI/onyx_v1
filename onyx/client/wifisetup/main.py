...
class WiFi:
    ...
    def init_events(self):
        ...
        self.ws.on('onyx.wifi.reset', self.reset)

        # an event to enable SSH
        self.ws.on('onyx.enable.ssh', self.ssh_enable)
        self.ws.on('onyx.disable.ssh', self.ssh_disable)
